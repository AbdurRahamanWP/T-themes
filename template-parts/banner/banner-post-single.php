<?php 
  ...
  * Display page banner 
  */
$show_banner = zafram_options('zafram_single_blog_banner_toggle', 'show');
$show_banner_in_page = zafram_page_meta('is_banner', get_the_ID(), 1);

$banner_url = zafram_options('zafram_single_blog_banner_upload');
$banner_url_page= zafram_page_meta('banner_background_image', get_the_ID());  

$how_title = zafram_options('zafram_single_blog_banner_title', 'show');
$show_breadcrumbs = zafram_options('zafram_single_blog_banner_breadcrumb', 'show');
