...
add_filter( 'pt-ocdi/import_files', 'zafram_import_files' );
function zafram_import_files() {
    return array(

        array(
            'import_file_name'             => esc_html__('Light Demos', 'zafram'),
            ...
            'preview_url'                  => 'https://zafram.droitlab.com/',
...
function zafram_after_import_setup() {
    ...
    $front_page_id = get_page_by_title( 'Home One -Business Agency' );
...
add_action( 'pt-ocdi/after_import', 'zafram_after_import_setup' );